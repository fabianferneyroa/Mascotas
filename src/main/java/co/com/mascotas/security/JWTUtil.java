package co.com.mascotas.security;
...
public class JWTUtil {
	...
	public String crearToken(String id, String email) {
		...
		JwtBuilder builder = Jwts.builder().setId(id).setIssuedAt(now).setSubject(email).setIssuer(issuer)
	...
	// lee y valida un el email del jwt
